...
"d) Python code is only interpreted"],
  2: ["2. All keywords in Python are in _________",
"a) Capitalized",
"b) lower case",
"c) UPPER CASE",
"d) None of the mentioned]"],
  3: ["3. Which of the following is used to define a block of code in Python language?", "a) Indentation",
"b) Key",
"c) Brackets",
"d) All of the mentioned"],
  4: ["4. Which keyword is used for function in Python language?",
"a) Function",
"b) def",
"c) Fun",
"d) Define"]
...
const pythonHardQust = {
  1: ["1. Which of the following character is used to give single-line comments in Python?",
"a) //",
"b) #",
"c) !",
"d) /*"],
...
"c) lambda",
"d) none of the mentioned"],
  4: ["4. What is the order of precedence in python?",
...
function back_play_page() {
  ...
  if (play_container.lastElementChild.className == open_page) {
    console.log(play_container.lastElementChild.className);
    play_container.style.visibility = "hidden"
    login_container.style.visibility = "visible"
  }
  else if (quiz_option.lastElementChild.className == open_page) {
    console.log(quiz_option.lastElementChild.className)
...
function showEasy() {
  ...
  // console.log(cppEasyQust[1][0])
  // console.log(cppEasyAns==cppEasyQust[1][3].slice(0,1));
}
...
// console.log(level_container.children[2].children[0].textContent)
// console.log(level_container.children[3].children[0].textContent)
// console.log(level_container.children[4].children[0].textContent)
